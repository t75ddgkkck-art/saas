    ...
    <div className="relative w-full max-w-md">
      <div className="relative">
        ...
        <label htmlFor="global-search-input" className="sr-only">
          Rechercher un artisan, un service ou un article
        </label>
        <input
        ...
        {query && (
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 rounded"
          >
      ...
      {isOpen && results.length > 0 && (
        <div
          ...
          role="listbox"
          className="absolute top-full mt-2 w-full rounded-2xl border border-slate-200 bg-white shadow-xl dark:border-slate-800 dark:bg-slate-900 z-50"
        >
