  ...
  plombier: {
    ...
    fields: [
      ...
      },
      {
        ...
        placeholder:
          "Ex: Fuite sous l'évier de la cuisine depuis ce matin, l'eau coule en continu...",
        required: true,
      },
      {
        id: "rooms_affected",
      ...
      },
      {
        id: "building_age",
        type: "select",
        label: "Âge approximatif du bâtiment",
        required: false,
        options: [
  ...
  electricien: {
    ...
    fields: [
      ...
      },
      {
        ...
        placeholder: "Ex: Disjoncteur qui saute régulièrement dans la cuisine...",
        required: true,
      },
      {
        id: "nb_pieces",
  ...
  coiffeur: {
    ...
    fields: [
      ...
      },
      {
        id: "preferences",
        type: "textarea",
        label: "Précisions / Envies",
        placeholder: "Ex: Je voudrais une coupe courte avec des mèches blondes...",
        required: false,
      },
      {
        id: "allergies",
        type: "checkbox",
        label: "Allergies connues (coloration, etc.)",
        required: false,
      },
      {
        id: "budget",
  ...
  peintre: {
    ...
    fields: [
      ...
      },
      {
        ...
        placeholder:
          "Ex: Peinture blanche pour le salon et les chambres, peinture bleue pour la chambre d'enfant...",
        required: true,
      },
      {
        id: "state",
        type: "select",
        label: "État actuel des murs",
        required: false,
        options: [
      ...
      },
      {
        ...
        placeholder: "Ex: Blanc mat pour le plafond, gris perle pour les murs...",
        required: false,
      },
    ],
    ...
    fields: [
      {
        id: "vehicle_info",
        type: "text",
        label: "Véhicule (marque, modèle, année)",
      ...
      },
      {
        id: "km",
        type: "number",
        label: "Kilométrage approximatif",
  ...
  couvreur: {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "textarea",
        label: "Décrivez le problème",
        placeholder: "Ex: Fuite au niveau de la cheminée, tuiles cassées après la tempête...",
        required: true,
      },
      {
        id: "floors",
  ...
  menuisier: {
    ...
    fields: [
      ...
      },
      {
        ...
        placeholder: "Ex: Porte 90x210cm, dressing 2m de large sur 2.5m de haut...",
        required: false,
      },
      {
        id: "description",
        type: "textarea",
        label: "Détails du projet",
        placeholder: "Ex: Je souhaite un dressing sur mesure avec étagères et penderie...",
        required: true,
      },
    ],
