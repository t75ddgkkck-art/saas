...
const TRANSLATIONS = {
  fr: {
    ...
    reactivationNav: "À recontacter",
    parrainageNav: "Parrainage",
  ...
  en: {
    ...
    reactivationNav: "Reconnect",
    parrainageNav: "Refer & Earn",
    todayNav: "Today",
    settings: "Settings",
    logout: "Log out",
  ...
  es: {
    ...
    teamNav: "Equipo",
    invoicesNav: "Facturas",
    reactivationNav: "Reconectar",
    parrainageNav: "Recomendar",
    todayNav: "Hoy",
    settings: "Ajustes",
  ...
  de: {
    ...
    reactivationNav: "Nachfassen",
    parrainageNav: "Empfehlen",
    todayNav: "Heute",
