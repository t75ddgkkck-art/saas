        ...
        <div className="mt-8 space-y-8 text-slate-700 dark:text-slate-300">
          <section>
            ...
            <p className="mt-2 text-sm leading-relaxed">
              Pour les données que vous nous confiez en tant qu&apos;utilisateur inscrit (compte,
              abonnement), <strong>{publisherName}</strong> est responsable de traitement.
            </p>
            <p className="mt-2 text-sm leading-relaxed">
              Pour les données de vos propres clients (que vous saisissez dans le CRM, RDV, devis,
              factures), <strong>vous êtes le responsable de traitement</strong> et {publisherName}{" "}
              agit en qualité de sous-traitant au sens du RGPD article 28. Voir la clause DPA dans
              les{" "}
            ...
            <div className="mt-3 overflow-x-auto">
              <table className="min-w-full text-sm">
                ...
                <tbody className="text-slate-600 dark:text-slate-400">
                  <Row
                    cat="Identité (nom, prénom, email, téléphone)"
                    fin="Création et gestion du compte, authentification"
                    base="Contrat (art. 6.1.b)"
                  />
                  <Row
                    cat="Données pro (SIRET, dénomination, adresse)"
                    fin="Vérification INSEE, affichage sur vitrine"
                    base="Contrat (art. 6.1.b)"
                  />
                  <Row
                    cat="Données de paiement (via Stripe)"
                    fin="Facturation abonnement"
                    base="Contrat (art. 6.1.b)"
                  />
                  <Row
                    cat="Logs techniques (IP, user-agent)"
                    fin="Sécurité, prévention de la fraude, débogage"
                    base="Intérêt légitime (art. 6.1.f)"
                  />
                  <Row
                    cat="Cookies de session"
                    fin="Maintenir la connexion"
                    base="Strictement nécessaire (dispensé de consent)"
                  />
                  <Row
                    cat="Données clients saisies par le pro (CRM, RDV, notes)"
                    fin="Fournir l'outil au pro (nous sommes sous-traitants)"
                    base="Responsable = le pro"
                  />
                  <Row
                    cat="Emails/SMS envoyés"
                    fin="Notifications transactionnelles, rappels"
                    base="Contrat + intérêt légitime"
                  />
                  <Row
                    cat="Historique IA (prompts, tokens)"
                    fin="Quota, facturation, amélioration service"
                    base="Contrat + intérêt légitime"
                  />
                </tbody>
              </table>
          ...
          <section>
            ...
            <p className="mt-2 text-sm leading-relaxed">
              Les données ne sont accessibles qu&apos;aux personnes strictement habilitées (équipe
              technique {publisherName}) et aux sous-traitants suivants, sélectionnés pour leur
              conformité RGPD :
            </p>
            <div className="mt-3 overflow-x-auto">
              <table className="min-w-full text-sm">
                ...
                <tbody className="text-slate-600 dark:text-slate-400">
                  ...
                  <SubRow
                    name="Vercel Inc."
                    role="Hébergement application, edge functions"
                    loc="USA + edge global"
                    g="EU-US Data Privacy Framework + CCT"
                  />
                  <SubRow
                    name="Stripe Payments Europe"
                    role="Paiements et facturation"
                    loc="Irlande (UE) + USA"
                    g="PCI-DSS niveau 1 + CCT"
                  />
                  <SubRow
                    name="Resend"
                    role="Envoi emails transactionnels"
                    loc="USA"
                    g="CCT + DPA signé"
                  />
                  <SubRow
                    name="OpenAI"
                    role="Génération IA (chatbot, blog, réponses avis)"
                    loc="USA"
                    g="CCT + zero-retention API"
                  />
                  <SubRow
                    name="IONOS"
                    role="Registrar de domaine"
                    loc="Allemagne (UE)"
                    g="Hébergement UE"
                  />
                </tbody>
            ...
            <p className="mt-3 text-sm leading-relaxed">
              Les données ne sont <strong>jamais vendues à des tiers</strong> à des fins
          ...
          <section>
            ...
            <p className="mt-2 text-sm leading-relaxed">
              Certains sous-traitants (Stripe, OpenAI, Vercel, Resend) sont établis aux États-Unis.
              Les transferts sont encadrés par :
            </p>
            <ul className="mt-2 list-disc space-y-1 pl-6 text-sm">
              <li>
                Les <strong>Clauses Contractuelles Types</strong> (décision UE 2021/914) signées
                avec chaque sous-traitant
              </li>
              <li>
                L&apos;adhésion au <strong>EU-US Data Privacy Framework</strong> pour les
                sous-traitants certifiés
              </li>
              <li>Le chiffrement systématique des données en transit (TLS 1.2+)</li>
            </ul>
          </section>
            ...
            <div className="mt-3 overflow-x-auto">
              <table className="min-w-full text-sm">
                ...
                <tbody className="text-slate-600 dark:text-slate-400">
                  ...
                  <DurRow
                    d="Compte supprimé (soft delete)"
                    t="30 jours avant purge finale automatique"
                  />
                  <DurRow
                    d="Factures et données comptables"
                    t="10 ans (obligation légale L123-22 C. commerce)"
                  />
                  <DurRow
                    d="Logs de connexion et sécurité"
                    t="12 mois (LCEN, obligation opérateur)"
                  />
                  <DurRow
                    d="Emails de désinscription (opt-out)"
                    t="3 ans après la dernière interaction"
                  />
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-1 pl-6 text-sm">
              <li>
                <strong>Accès (art. 15)</strong> et <strong>portabilité (art. 20)</strong> : bouton
                &laquo; Exporter mes données &raquo; dans les paramètres → JSON machine-readable
              </li>
              <li>
                <strong>Rectification (art. 16)</strong> : modifiable directement depuis votre
                dashboard, ou par email
              </li>
              <li>
                <strong>Effacement (art. 17)</strong> : bouton &laquo; Supprimer mon compte &raquo;
                dans les paramètres → soft delete immédiat, purge finale sous 30 jours
              </li>
              <li>
                <strong>Opposition (art. 21)</strong> et <strong>limitation (art. 18)</strong> : sur
                demande à{" "}
                <a
                  href={`mailto:${dpoEmail}`}
                  className="text-blue-600 hover:underline dark:text-blue-400"
              ...
              <li>
                <strong>Désinscription emails</strong> : lien &laquo; Se désinscrire &raquo; dans
                chaque email + endpoint one-click RFC 8058
              </li>
            </ul>
            <p className="mt-3 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100">8. Cookies</h2>
            <p className="mt-2 text-sm leading-relaxed">
              Vitrix n&apos;utilise <strong>que des cookies strictement nécessaires</strong> au
              fonctionnement (session de connexion). Aucun cookie publicitaire, analytique ou de
              pistage tiers n&apos;est déposé.
            </p>
            <p className="mt-2 text-sm leading-relaxed">
              Conformément à la directive ePrivacy et à la doctrine CNIL, les cookies strictement
              nécessaires sont dispensés de consentement. Une bannière informative est néanmoins
              affichée pour transparence.
            </p>
          </section>
...
function SubRow({ name, role, loc, g }: { name: string; role: string; loc: string; g: string }) {
  return (
    <tr className="border-b border-slate-100 last:border-0 dark:border-slate-800/50">
